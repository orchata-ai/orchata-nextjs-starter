...
export const SearchIcon = ({ size = 16 }: { size?: number }) => (
  ...
  >
    <path
      clipRule="evenodd"
      d="M6.5 12C9.53757 12 12 9.53757 12 6.5C12 3.46243 9.53757 1 6.5 1C3.46243 1 1 3.46243 1 6.5C1 9.53757 3.46243 12 6.5 12ZM6.5 13.5C4.3114 13.5 2.33886 12.5891 0.967407 11.1217L0.43708 10.5914L1.49774 9.53074L2.02807 10.0611C3.11989 11.1529 4.63153 11.8213 6.29012 11.9818L10.4697 7.80218L11 7.27185L12.0607 8.33251L11.5303 8.86284L8.21608 12.1771C9.64196 11.7236 10.8798 10.8204 11.7574 9.63285L12.1999 9.02726L13.411 9.91209L12.9685 10.5177C11.7316 12.192 9.76457 13.299 7.53852 13.4627C7.19893 13.4874 6.85341 13.5 6.5 13.5ZM14.5303 13.4697L15.0607 14L14 15.0607L13.4697 14.5303L10.7197 11.7803L10.1893 11.25L11.25 10.1893L11.7803 10.7197L14.5303 13.4697Z"
      fill="currentColor"
      fillRule="evenodd"
    />
  </svg>
...
export const DatabaseIcon = ({ size = 16 }: { size?: number }) => (
  ...
  >
    <path
      clipRule="evenodd"
      d="M8 1.5C5.51472 1.5 3.5 2.34315 3.5 3.5V4.5C3.5 5.65685 5.51472 6.5 8 6.5C10.4853 6.5 12.5 5.65685 12.5 4.5V3.5C12.5 2.34315 10.4853 1.5 8 1.5ZM2 3.5C2 1.567 4.68629 0 8 0C11.3137 0 14 1.567 14 3.5V4.5V8V12.5C14 14.433 11.3137 16 8 16C4.68629 16 2 14.433 2 12.5V8V4.5V3.5ZM3.5 6.31102C4.63144 6.91449 6.24467 7.28571 8 7.28571C9.75533 7.28571 11.3686 6.91449 12.5 6.31102V8C12.5 9.15685 10.4853 10 8 10C5.51472 10 3.5 9.15685 3.5 8V6.31102ZM3.5 9.81102C4.63144 10.4145 6.24467 10.7857 8 10.7857C9.75533 10.7857 11.3686 10.4145 12.5 9.81102V12.5C12.5 13.6569 10.4853 14.5 8 14.5C5.51472 14.5 3.5 13.6569 3.5 12.5V9.81102Z"
      fill="currentColor"
      fillRule="evenodd"
    />
  </svg>
...
export const FolderIcon = ({ size = 16 }: { size?: number }) => (
  ...
  >
    <path
      clipRule="evenodd"
      d="M0 2.5V12.5C0 13.8807 1.11929 15 2.5 15H13.5C14.8807 15 16 13.8807 16 12.5V5.5C16 4.11929 14.8807 3 13.5 3H8.20711L6.85355 1.64645L6.5 1.29289L6.14645 1.64645L5.39645 2.39645L6.1 3.1L6.29289 2.90711L6.79289 3.40711L7.79289 4.40711L8.08579 4.7H8.5H13.5C14.0523 4.7 14.5 5.14772 14.5 5.7V12.5C14.5 13.0523 14.0523 13.5 13.5 13.5H2.5C1.94772 13.5 1.5 13.0523 1.5 12.5V2.5H6.08579L5.79289 2.79289L5.08579 3.5L5.39289 3.80711L6.09289 4.50711L6.8 3.8L6 3L5.5 2.5L6.08579 1.91421L6.5 1.5H1.5H0V2.5Z"
      fill="currentColor"
      fillRule="evenodd"
    />
  </svg>
...
export const OrchataLogo = ({ className }: { className?: string }) => {
  return (
    <>
      {/* biome-ignore lint: external SVG from CDN */}
      <img
        alt="Orchata"
        className={cn(className, "dark:hidden")}
        height={24}
        src="https://cdn.orchata.ai/img/orchata-logo-light.svg"
        width={120}
      />
      {/* biome-ignore lint: external SVG from CDN */}
      <img
        ...
        height={24}
        src="https://cdn.orchata.ai/img/orchata-logo-dark.svg"
        width={120}
      />
    </>
  );
